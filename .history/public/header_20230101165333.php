...
<div class=" row  d-flex align-items-start">
    ...
    <div class=" col-4 navbar-brand pt-0 fs-2"style="background-color:orange" href="#">Les Caravanes De La Besbre <span class="orange">.</span></div>
</div>
        ...
        <div class="row">
          <div class="col-md-6 gx-5 mb-4">
            <div class="bg-image hover-overlay ripple shadow-2-strong rounded-5" data-mdb-ripple-color="light">
              <img src="../images/banner3.png" class="img-fluid ps-1" />
              <a href="#!">
